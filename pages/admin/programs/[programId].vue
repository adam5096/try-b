	...
	<div class="mx-auto w-full max-w-container-admin space-y-6">
			...
			<div class="grid gap-8 md:grid-cols-2">
				...
				<dl class="space-y-4">
					...
					<div>
						...
						<dd class="mt-0.5 text-gray-900">
							{{ program.publishFrom }} 至 {{ program.publishTo }}
						</dd>
					</div>
					<div>
						<dt class="text-sm text-gray-500">
			...
			<div class="space-y-8">
				...
				<div v-if="parsedIntro?.requirements && parsedIntro.requirements.length > 0">
					...
					<ol class="list-decimal space-y-1 pl-6 text-gray-800">
						<li
							v-for="(req, idx) in parsedIntro.requirements"
							:key="idx"
						>
							{{ req }}
						</li>
		...
		<section class="rounded border border-gray-200 bg-white p-4 shadow-sm md:p-6">
			<div class="space-y-8">
				...
				<div v-if="parsedIntro?.preparation && parsedIntro.preparation.length > 0">
					...
					<ol class="list-decimal space-y-1 pl-6 text-gray-800">
						<li
							v-for="(item, i) in parsedIntro.preparation"
							:key="i"
						>
							{{ item }}
						</li>
				...
				<div>
					...
					<div class="space-y-3 text-gray-800">
						<div
							v-for="(d, i) in program.itinerary"
							:key="i"
							class="flex gap-4"
						>
							<div class="w-14 shrink-0 font-semibold text-gray-900">
								{{ d.day }}
							</div>
		...
		<section class="rounded border border-gray-200 bg-white p-4 shadow-sm md:p-6">
			...
			<div class="mt-6 grid gap-6 md:grid-cols-2">
				<figure
					v-for="(photo, i) in program.photos"
					:key="i"
					class="space-y-2"
				>
			...
			<div class="overflow-x-auto">
				<table class="min-w-full divide-y divide-gray-200">
					...
					<tbody class="divide-y divide-gray-100 bg-white">
						<tr
							v-for="(h, idx) in program.reviewHistory"
							:key="idx"
			...
			>
				<div class="space-y-1">
					...
					<select
						...
						class="w-full rounded border border-gray-300 px-3 py-2 text-sm text-gray-900 outline-none focus:border-primary-blue focus:ring-1 focus:ring-primary-blue"
					>
