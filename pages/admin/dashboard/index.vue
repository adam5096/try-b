				...
				>
					...
					<div class="mt-2 flex items-center gap-2 text-sm">
						...
						>
							<path
								fill-rule="evenodd"
								d="M12 5.25a.75.75 0 01.75.75v10.19l3.22-3.22a.75.75 0 111.06 1.06l-4.5 4.5a.75.75 0 01-1.06 0l-4.5-4.5a.75.75 0 111.06-1.06l3.22 3.22V6a.75.75 0 01.75-.75z"
								clip-rule="evenodd"
							/>
						</svg>
				...
				>
					...
					<div class="relative h-56 w-full overflow-hidden rounded bg-white">
						...
						<div class="absolute inset-0 translate-y-2 p-4">
							<div class="h-full w-full rounded bg-brand-gray" />
						</div>
						<!-- x label -->
				...
				>
					...
					<div class="flex h-56 w-full flex-col justify-between">
						<div class="flex flex-1 items-center justify-center">
							<div class="h-40 w-40 rounded-full bg-brand-gray" />
						</div>
						<div class="mt-3 flex items-center gap-6 text-sm">
							<span class="inline-flex items-center gap-2 text-gray-700"><span class="inline-block h-3 w-3 rounded-sm bg-green-400" />綠色產業類</span>
							<span class="inline-flex items-center gap-2 text-gray-700"><span class="inline-block h-3 w-3 rounded-sm bg-blue-400" />資訊類</span>
							<span class="inline-flex items-center gap-2 text-gray-700"><span class="inline-block h-3 w-3 rounded-sm bg-gray-500" />行銷與設計類</span>
						</div>
					</div>
				</el-card>
			</div>
		...
		<section class="space-y-4">
			...
			<div class="overflow-hidden rounded border border-gray-200 bg-white">
				...
				>
					...
					<div class="text-sm text-gray-800 md:text-center">
						收藏次數：{{ p.favorites }} 次
					</div>
					<div class="text-sm text-gray-800 md:text-right">
						已申請人數：{{ p.applicants }} 人
					</div>
				</div>
			</div>
		</section>
