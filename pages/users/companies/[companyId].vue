				...
				<section class="lg:col-span-8 space-y-8">
					...
					>
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							>
								<div class="h-28 bg-gray-200 rounded mb-3 flex items-center justify-center text-gray-500">
									圖片(體驗縮圖)
								</div>
				...
				<aside class="lg:col-span-4 space-y-6">
					...
					>
						...
						<dl class="text-gray-700 space-y-2">
							<div
								v-for="(meta, i) in companyInfo"
								:key="i"
								class="grid grid-cols-3 gap-2"
							>
								<dt class="col-span-1 text-gray-500">
									{{ meta.label }}
								</dt>
								<dd class="col-span-2">
									{{ meta.value }}
