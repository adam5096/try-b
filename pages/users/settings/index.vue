	...
	<main class="min-h-screen bg-brand-gray">
		<div class="mx-auto max-w-container-users px-6 py-12 md:px-12">
			...
			<div class="rounded-lg bg-white p-8 shadow-sm">
				<h2 class="mb-6 text-xl font-bold text-primary-blue-dark">
					個人資料設定
				</h2>
					...
					<div class="grid grid-cols-1 gap-x-12 gap-y-2 md:grid-cols-2">
						...
						>
							<div class="grid w-full grid-cols-1 gap-4 xl:grid-cols-2">
								...
								<el-select
									v-model="personalInfo.address.district"
									placeholder="鄉鎮市區"
								>
									<el-option
										v-for="item in districtOptions[personalInfo.address.city]"
										:key="item.value"
										:label="item.label"
										:value="item.value"
									/>
							...
							<el-input
								v-model="personalInfo.address.street"
								class="mt-4 w-full"
							/>
						</el-form-item>
					</div>
