	...
	<div class="min-h-screen w-full bg-white text-gray-900">
		...
		<header class="flex h-16 w-full items-center justify-between bg-gray-700 px-4 text-white md:px-6 xl:px-8 header-compact">
			<div class="flex items-center gap-3">
				<div class="flex h-8 w-12 items-center justify-center rounded bg-gray-600 text-[10px]">
					LOGO
				</div>
				...
				<div class="hidden items-center gap-2 md:flex">
					<div class="flex h-9 w-9 items-center justify-center rounded-full bg-gray-600">
						...
						>
							<path
								fill-rule="evenodd"
								d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM5.25 20.1a7.5 7.5 0 0113.5 0 .9.9 0 01-.9.9H6.15a.9.9 0 01-.9-.9z"
								clip-rule="evenodd"
							/>
						</svg>
					</div>
					...
					>
						<span class="flex items-center gap-3">
							<span
								...
								class="block h-5 w-1 rounded bg-gray-400"
							/>
