...
<template>
	<div>
						...
						<nav>
							<ul v-if="authStore.isLoggedIn">
								...
								>
									<NuxtLink
										:to="link.route"
										class="flex items-center gap-3 px-4 py-3 rounded-md text-gray-700 hover:bg-gray-100 transition-colors text-lg"
								...
								<li>
									<button
										class="w-full flex items-center gap-3 px-4 py-3 rounded-md text-gray-700 hover:bg-gray-100 transition-colors text-lg"
										@click="handleLogout"
									>
										<font-awesome-icon
											:icon="['fas', 'arrow-right-from-bracket']"
		...
		<main
			class="pt-[90px] bg-brand-gray transition-all duration-300 ease-in-out"
			:style="{ paddingTop: `${90 + menuHeight}px` }"
		>
