...
<template>
	<div>
              ...
              <input type="text" placeholder="搜尋職業體驗機會..." class="w-full bg-transparent focus:outline-none">
				...
				<div class="flex items-center">
					...
					>
						...
						<button
							class="absolute top-8 right-8 lg:hidden"
							@click="toggleMenu"
						>
		...
		<footer class="relative text-white bg-cover bg-center overflow-hidden">
			...
			<!-- Blue Overlay Layer -->
			<div class="absolute inset-0 z-10 bg-primary-blue opacity-90" />
					...
					<div class="flex flex-col items-center md:items-start">
						...
						<div class="mt-6 flex gap-6">
							<a
								...
								:key="link.name"
								:href="link.href"
								class="text-white hover:text-btn-yellow transition-colors"
							>
								<font-awesome-icon
									:icon="link.icon"
									class="h-8 w-8"
					...
					<div>
						...
						<ul class="space-y-2">
							...
							>
								<NuxtLink
									:to="link.href"
									class="hover:text-btn-yellow transition-colors"
								>{{ link.text }}</NuxtLink>
							</li>
						</ul>
					</div>
