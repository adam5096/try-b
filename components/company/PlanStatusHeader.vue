				...
				<el-skeleton animated>
					<template #template>
						<div class="flex flex-wrap items-center gap-3">
							<el-skeleton-item
								variant="text"
								style="width: 140px; height: 20px; border-radius: 9999px"
							/>
							<el-skeleton-item
								variant="text"
								style="width: 220px; height: 20px; border-radius: 9999px"
							/>
							<el-skeleton-item
								variant="text"
								style="width: 100px; height: 20px; border-radius: 9999px"
							/>
						</div>
					</template>
				</el-skeleton>
