<template>
  <div class="animate-pulse">
    ...
    <div v-if="showTitle" class="mb-4">
      ...
      <div class="h-4 bg-gray-300 rounded w-1/2 skeleton"></div>
    </div>
    
    <!-- 內容骨架 -->
    <div class="space-y-4">
      <!-- 圖片骨架 -->
      <div v-if="showImage" class="bg-gray-300 rounded-lg skeleton" :class="imageHeightClass"></div>
      ...
      <div v-if="showButton" class="pt-2">
        <div class="bg-gray-300 rounded-lg w-full skeleton" :class="buttonHeightClass"></div>
      </div>
    </div>
  </div>
</template>
